...
const bodyFront_1 = require("./assets/bodyFront.js");
const bodyBack_1 = require("./assets/bodyBack.js");
const SvgMaleWrapper_1 = require("./components/SvgMaleWrapper.js");
const SvgFemaleWrapper_1 = require("./components/SvgFemaleWrapper.js");
...
const Body = ({ colors = ["#0984e3", "#74b9ff"], data, scale = 1, side = "front", gender = "male", onBodyPartPress, border = "#dfdfdf", disabledParts = [], hiddenParts = [], defaultFill = "#3f3f3f", defaultStroke = "none", defaultStrokeWidth = 0 }) => {
    ...
    if (gender === "female") {
        try {
            const bodyFemaleFront_1 = require("./assets/bodyFemaleFront.js");
            const bodyFemaleBack_1 = require("./assets/bodyFemaleBack.js");
